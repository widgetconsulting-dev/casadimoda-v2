      ...
      <div className="max-w-7xl mx-auto px-3 md:px-8 py-4 md:py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12">
          ...
          <div className="flex flex-col">
            ...
            {/* Wishlist */}
            <button className="w-full py-2.5 md:py-3 border border-gray-200 hover:border-primary text-primary/60 hover:text-primary text-[10px] md:text-xs font-medium uppercase tracking-wider transition-all cursor-pointer flex items-center justify-center gap-2 mb-5 md:mb-8">
