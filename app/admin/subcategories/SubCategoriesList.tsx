...
export default function SubCategoriesList({
    ...
    const { register, handleSubmit, reset, setValue } = useForm<SubCategoryFormData>();
    ...
    const onSubmit = async (data: SubCategoryFormData) => {
        ...
        const body = editingSub ? { ...data, id: editingSub._id, slug } : { ...data, slug };
                    ...
                    subcategories.map((sub) => (
                        ...
                        >
                            ...
                            <div className="mb-2">
                                ...
                                <h3 className="text-xl font-black text-primary mt-2">{sub.name}</h3>
                            </div>
